    ...
    content {
      ...
      dynamic "application_stack" {
        ...
        content {
          ...
          dotnet_core_version          = lookup(var.site_config.application_stack, "dotnet_core_version", null)
          tomcat_version               = lookup(var.site_config.application_stack, "tomcat_version", null)
          java_embedded_server_enabled = lookup(var.site_config.application_stack, "java_embedded_server_enabled", false)
          ...
          python                       = lookup(var.site_config.application_stack, "python", false) || lookup(var.site_config.application_stack, "python_version", null) != null
        }
      }
